...
export default function Film(props) {
  ...
  return (
    <div className="mr-3 max-h-full bg-gray-100 bg-opacity-75 px-8 pt-8 pb-10 rounded-lg overflow-hidden text-center relative">
      <div
        style={{
      ...
      <button className="bg-orange-600 block w-full py-1 rounded-sm btnBookingTick mt-3">
